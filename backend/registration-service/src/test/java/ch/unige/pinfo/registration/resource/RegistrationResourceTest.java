...
class RegistrationResourceTest {
	...
	// Replace your old constants with these calculated values:
	private static final UUID STUDENT = UUID
			.nameUUIDFromBytes("auth0|test-student-id".getBytes(java.nio.charset.StandardCharsets.UTF_8));
	private static final UUID ORGANIZER = UUID
			.nameUUIDFromBytes("auth0|test-organizer-id".getBytes(java.nio.charset.StandardCharsets.UTF_8));
