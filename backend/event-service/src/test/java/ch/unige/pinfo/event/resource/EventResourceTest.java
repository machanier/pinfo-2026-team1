...
class EventResourceTest {
    ...
    void updateEvent_setValidBannerImageUrl_returns200WithBannerUrl() {
        ...
        given()
                ...
                .then()
                .statusCode(200)
                .body("bannerImageUrl", equalTo("https://res.cloudinary.com/demo/image/upload/sample.jpg"));
    }
    ...
    void updateEvent_omitBannerImageUrl_leavesExistingBannerUnchanged() {
        UUID organizerId = organizerIdFromSubject(AUTH0_ORGANIZER);
        Event event = persistEventWithBanner(organizerId, "https://res.cloudinary.com/demo/image/upload/existing.jpg");
        when(jwt.getSubject()).thenReturn(AUTH0_ORGANIZER);
        ...
        given()
                ...
                .then()
                .statusCode(200)
                .body("bannerImageUrl", equalTo("https://res.cloudinary.com/demo/image/upload/existing.jpg"));
    }
    ...
    void deleteBanner_returns204AndClearsBannerUrl() {
        UUID organizerId = organizerIdFromSubject(AUTH0_ORGANIZER);
        Event event = persistEventWithBanner(organizerId, "https://res.cloudinary.com/demo/image/upload/banner.jpg");
        when(jwt.getSubject()).thenReturn(AUTH0_ORGANIZER);
    ...
    void deleteBanner_byNonOwner_returns403() {
        ...
        Event event = persistEventWithBanner(ownerId, "https://res.cloudinary.com/demo/image/upload/banner.jpg");
        when(jwt.getSubject()).thenReturn(AUTH0_OTHER_ORGANIZER);
