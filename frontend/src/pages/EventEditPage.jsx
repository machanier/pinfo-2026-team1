...
export default function EventEditPage() {
  ...
  return (
    <section className="mx-auto w-full max-w-3xl rounded-xl border bg-white p-6 shadow-sm">
      <h1 className="text-2xl font-bold text-gray-900">Édition événement #{id}</h1>
      <p className="mt-1 text-sm text-gray-600">Mise à jour des informations d'un événement.</p>
